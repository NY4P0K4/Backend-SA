...
` +
    ...
    var Un = wn(
      ...
      Gn = wn(h({}, Tn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Kn = wn(
        h({}, Mn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      qn = wn(h({}, Tn, { newState: 0, oldState: 0 })),
      Jn = [9, 13, 27, 32],
...
function ht(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    if (j.isReactNative(t) && j.isReactNativeBlob(e))
      return (t.append(ft(i, n, a), u(e)), !1);
    ...
    return ut(e) ? !0 : (t.append(ft(i, n, a), u(e)), !1);
  }
  let f = [],
    p = Object.assign(mt, {
      defaultVisitor: d,
...
var xt = class {
  ...
  Ct = {
    isBrowser: !0,
    classes: {
      URLSearchParams: typeof URLSearchParams < `u` ? URLSearchParams : _t,
  ...
  Et =
    N && (!Tt || [`ReactNative`, `NativeScript`, `NS`].indexOf(Tt.product) < 0),
  Dt =
    typeof WorkerGlobalScope < `u` &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == `function`,
  Ot = (N && window.location.href) || `http://localhost`,
  kt = { ...wt, ...Ct };
function At(e, t) {
  return ht(e, new kt.classes.URLSearchParams(), {
    visitor: function (e, t, n, r) {
      return kt.isNode && j.isBuffer(e)
    ...
    return (
      ...
      s
        ...
        : ((!r[a] || !j.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && j.isArray(r[a]) && (r[a] = Mt(r[a])),
          !o)
    );
  }
...
var Pt = (e, t) => (e != null && j.hasOwnProp(e, t) ? e[t] : void 0);
function Ft(e, t, n) {
  if (j.isString(e))
    try {
...
charset=utf-8`,
      ...
      let a;
      if (i) {
        let t = Pt(this, `formSerializer`);
        if (n.indexOf(`application/x-www-form-urlencoded`) > -1)
          return At(e, t).toString();
        if ((a = j.isFileList(e)) || n.indexOf(`multipart/form-data`) > -1) {
          let n = Pt(this, `env`),
            r = n && n.FormData;
          return ht(a ? { "files[]": e } : e, r && new r(), t);
        }
      }
  ...
  transformResponse: [
    function (e) {
      let t = Pt(this, `transitional`) || It.transitional,
        n = t && t.forcedJSONParsing,
        r = Pt(this, `responseType`),
        i = r === `json`;
      if (j.isResponse(e) || j.isReadableStream(e)) return e;
      if (e && j.isString(e) && ((n && !r) || i)) {
        let n = !(t && t.silentJSONParsing) && i;
        try {
          return JSON.parse(e, Pt(this, `parseReviver`));
        } catch (e) {
          if (n)
            throw e.name === `SyntaxError`
              ? M.from(e, M.ERR_BAD_RESPONSE, this, null, Pt(this, `response`))
              : e;
        }
      }
      return e;
...
var Wt = (e, t, n = 3) => {
  ...
  Kt =
    ...
    (...t) =>
      j.asap(() => e(...t)),
  qt = kt.hasStandardBrowserEnv
    ? ((e, t) => (n) => (
        (n = new URL(n, kt.origin)),
...
var nn = (e) =>
  ...
  rn = (e) => {
    ...
    if (
      ...
      (t.url = bt(Zt(l, d, u), e.params, e.paramsSerializer)),
      c &&
        s.set(
          `Authorization`,
          `Basic ` +
            btoa((c.username || ``) + `:` + (c.password ? nn(c.password) : ``)),
        ),
      j.isFormData(r) &&
        (kt.hasStandardBrowserEnv || kt.hasStandardBrowserWebWorkerEnv
          ? s.setContentType(void 0)
          : j.isFunction(r.getHeaders) &&
            tn(s, r.getHeaders(), n(`formDataHeaderPolicy`))),
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        (`onloadend` in h
          ...
          c && (([d, p] = Wt(c, !0)), h.addEventListener(`progress`, d)),
          s &&
            h.upload &&
            (([u, f] = Wt(s)),
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof M ? t : new zt(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
...
var fn = `1.16.0`,
  ...
  gn = (e) => {
    ...
    let { fetch: i, Request: a, Response: o } = e,
      s = i ? mn(i) : typeof fetch == `function`,
      c = mn(a),
      l = mn(o);
    if (!s) return !1;
    let u = s && mn(n),
      ...
      p = l && u && hn(() => j.isReadableStream(new o(``).body)),
      m = { stream: p && ((e) => e.body) };
    s &&
    ...
    let h = async (e) => {
        ...
        if (j.isSpecCompliantForm(e))
          return (
            await new a(kt.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
    ...
    return async (e) => {
      ...
      let T = on([l, u && u.toAbortSignal()], d),
        E = null,
        ne =
          T &&
          T.unsubscribe &&
        ...
        re;
      try {
        if (w && typeof t == `string` && t.startsWith(`data:`) && dn(t) > S)
          throw new M(
...
vn();
var yn = { http: null, xhr: an, fetch: { get: vn } };
j.forEach(yn, (e, t) => {
  if (e) {
    try {
...
var bn = (e) => `- ${e}`,
  xn = (e) => j.isFunction(e) || e === null || e === !1;
function Sn(e, t) {
  e = j.isArray(e) ? e : [e];
  let { length: n } = e,
    r,
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !xn(r) && ((i = yn[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
var Cn = { getAdapter: Sn, adapters: yn };
function wn(e) {
  if (
...
var kn = { assertOptions: On, validators: En },
  An = kn.validators,
  jn = class {
    constructor(e) {
      ((this.defaults = e || {}),
...
` + n);
    ...
    getUri(e) {
      return (
        (e = $t(this.defaults, e)),
        bt(
          Zt(e.baseURL, e.url, e.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer,
        )
      );
...
(j.forEach([`delete`, `get`, `head`, `options`], function (e) {
  ...
  j.forEach([`post`, `put`, `patch`, `query`], function (e) {
    ...
    ((jn.prototype[e] = t()),
      e !== `query` && (jn.prototype[e + `Form`] = t(!0)));
  }));
var Mn = class e {
  constructor(e) {
...
function In(e) {
  let t = new jn(e),
    n = p(jn.prototype.request, t);
  return (
    j.extend(n, jn.prototype, t, { allOwnKeys: !0 }),
...
((P.Axios = jn),
  ...
  (P.mergeConfig = $t),
  (P.AxiosHeaders = ot),
  (P.formToJSON = (e) => Nt(j.isHTMLForm(e) ? new FormData(e) : e)),
...
async function Rn() {
  return (await Ln.get(`/transactions`)).data;
}
async function zn(e) {
  return (await Ln.post(`/transactions`, e)).data;
}
async function Bn(e, t) {
  return (await Ln.put(`/transactions/${e}`, t)).data;
}
async function Vn(e) {
  await Ln.delete(`/transactions/${e}`);
}
function Hn(e) {
...
function Kn({ activeTab: e, onTabChange: t, saldo: n }) {
  return (0, F.jsxs)(`aside`, {
    ...
    children: [
      (0, F.jsxs)(`div`, {
        className: `logo`,
        children: [
          (0, F.jsx)(`span`, { className: `logo-icon`, children: `◈` }),
          (0, F.jsxs)(`span`, {
            className: `logo-text`,
            children: [`Finança`, (0, F.jsx)(`em`, { children: `S` })],
          }),
        ],
      }),
      (0, F.jsx)(`nav`, {
        ...
        children: Gn.map((n) =>
          (0, F.jsxs)(
            `button`,
            {
              className: `nav-item${e === n.id ? ` active` : ``}`,
              onClick: () => t(n.id),
              children: [
                (0, F.jsx)(`span`, { className: `nav-icon`, children: `⬡` }),
                n.label,
              ],
            },
            n.id,
      ...
      (0, F.jsx)(`div`, {
        ...
        children: (0, F.jsxs)(`div`, {
          className: `saldo-mini`,
          children: [
            (0, F.jsx)(`span`, { children: `Saldo atual` }),
            (0, F.jsx)(`strong`, {
              className: n >= 0 ? `pos` : `neg`,
              children: Hn(n),
            }),
          ],
        }),
...
function qn({ transactions: e }) {
  let t = e
      .filter((e) => e.tipo === `entrada`)
      .reduce((e, t) => e + t.valor, 0),
    n = e.filter((e) => e.tipo === `saida`).reduce((e, t) => e + t.valor, 0),
    r = t - n,
    i = {};
  e.filter((e) => e.tipo === `saida`).forEach((e) => {
    i[e.categoria] = (i[e.categoria] || 0) + e.valor;
  });
  ...
  return (0, F.jsxs)(`div`, {
    ...
    children: [
      (0, F.jsx)(`header`, {
        ...
        children: (0, F.jsxs)(`div`, {
          children: [
            (0, F.jsx)(`h1`, { children: `Dashboard` }),
            (0, F.jsx)(`p`, { children: `Visão geral do sistema financeiro` }),
          ],
        }),
      }),
      (0, F.jsxs)(`div`, {
        ...
        children: [
          (0, F.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(`div`, {
                className: `card-value ${r >= 0 ? `pos` : `neg`}`,
                children: Hn(r),
              }),
              (0, F.jsx)(`div`, {
                className: `card-sub`,
                children:
                  r >= 0 ? `Situação positiva` : `Atenção: saldo negativo`,
              }),
            ],
          }),
          (0, F.jsxs)(`div`, {
            className: `card card--entrada`,
            children: [
              (0, F.jsx)(`div`, {
                className: `card-label`,
              ...
              (0, F.jsx)(`div`, {
                className: `card-value pos`,
                children: Hn(t),
              }),
              (0, F.jsxs)(`div`, {
                className: `card-sub`,
                children: [
                  e.filter((e) => e.tipo === `entrada`).length,
                  ` transações`,
                ],
              }),
            ],
          ...
          (0, F.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(`div`, {
                className: `card-value neg`,
                children: Hn(n),
              }),
              (0, F.jsxs)(`div`, {
                className: `card-sub`,
                children: [
                  e.filter((e) => e.tipo === `saida`).length,
                  ` transações`,
                ],
              }),
            ],
          ...
          (0, F.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(`div`, {
                className: `card-value neutral`,
                children: e.length,
              }),
              (0, F.jsx)(`div`, {
                className: `card-sub`,
                children: `registros no total`,
              }),
            ],
          }),
        ],
      ...
      (0, F.jsxs)(`div`, {
        ...
        children: [
          (0, F.jsxs)(`div`, {
            ...
            children: [
              (0, F.jsx)(`h2`, { children: `Gastos por Categoria` }),
              a.length === 0
                ? (0, F.jsx)(`p`, {
                    className: `empty`,
          ...
          (0, F.jsxs)(`div`, {
            className: `recentes-section`,
            children: [
              (0, F.jsx)(`h2`, { children: `Últimas Transações` }),
              (0, F.jsx)(`div`, {
                className: `recentes-list`,
                children: e
                  .slice(0, 5)
                  .map((e) =>
                    (0, F.jsxs)(
                      `div`,
                      {
                        ...
                        children: [
                          (0, F.jsx)(`div`, {
                            className: `recente-dot ${e.tipo}`,
                          }),
                          (0, F.jsxs)(`div`, {
                            className: `recente-info`,
                            children: [
                              (0, F.jsx)(`span`, {
                                className: `recente-desc`,
                                children: e.descricao,
                              }),
                              (0, F.jsxs)(`span`, {
                                className: `recente-cat`,
                                children: [e.categoria, ` · `, Un(e.data)],
                              }),
                            ],
                          }),
                          (0, F.jsxs)(`span`, {
                            className: `recente-val ${e.tipo}`,
                            children: [
                              e.tipo === `entrada` ? `+` : `−`,
                              Hn(e.valor),
                            ],
...
function Jn({ field: e, sortField: t, sortDir: n }) {
  return t === e
    ? (0, F.jsx)(`span`, {
        className: `sort-icon active`,
        children: n === `asc` ? `↑` : `↓`,
      })
    : (0, F.jsx)(`span`, { className: `sort-icon`, children: `↕` });
}
function Yn({ transactions: e, onDelete: t, onEdit: n }) {
  let [r, i] = (0, d.useState)(`todos`),
    [a, o] = (0, d.useState)(`data`),
    [s, c] = (0, d.useState)(`desc`);
  function l(e) {
    a === e ? c((e) => (e === `asc` ? `desc` : `asc`)) : (o(e), c(`asc`));
  }
  let u = e
    .filter((e) => r === `todos` || e.tipo === r)
    .sort((e, t) => {
      let n = e[a],
        r = t[a];
      return (
        a === `valor` && ((n = +n), (r = +r)),
        n < r ? (s === `asc` ? -1 : 1) : n > r ? (s === `asc` ? 1 : -1) : 0
      );
    });
  return (0, F.jsxs)(`div`, {
    className: `page`,
    children: [
      (0, F.jsxs)(`header`, {
        ...
        children: [
          (0, F.jsxs)(`div`, {
            children: [
              (0, F.jsx)(`h1`, { children: `Transações` }),
              (0, F.jsx)(`p`, {
                children: `Histórico completo de movimentações`,
              }),
            ],
          }),
          (0, F.jsx)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(
                `button`,
                {
                  className: `filter-btn${r === e.key ? ` active` : ``}`,
                  onClick: () => i(e.key),
                  children: e.label,
                },
                e.key,
                      ...
                      (0, F.jsxs)(
                        `tr`,
                        {
                          ...
                          children: [
                            ...
                            (0, F.jsx)(`td`, {
                              children: (0, F.jsx)(`span`, {
                                className: `tipo-tag ${e.tipo}`,
                                children:
                                  e.tipo === `entrada` ? `Entrada` : `Saída`,
                              }),
                            }),
                            (0, F.jsxs)(`td`, {
                              className: `td-val ${e.tipo}`,
                              children: [
                                e.tipo === `entrada` ? `+` : `−`,
                                Hn(e.valor),
                              ],
      ...
      (0, F.jsxs)(`div`, {
        ...
        children: [u.length, ` registro(s) exibido(s)`],
      }),
    ],
  });
}
var Xn = [
  ...
  Zn = { descricao: ``, categoria: ``, valor: ``, data: ``, tipo: `saida` };
function Qn(e) {
  let t = {};
  return (
    e.descricao.trim() || (t.descricao = `Obrigatório`),
    e.categoria || (t.categoria = `Obrigatório`),
    (!e.valor || isNaN(e.valor) || +e.valor <= 0) &&
      (t.valor = `Valor inválido`),
    e.data || (t.data = `Obrigatório`),
    t
  );
}
function $n({ label: e, error: t, children: n }) {
  return (0, F.jsxs)(`div`, {
    className: `field${t ? ` field--error` : ``}`,
    children: [
      (0, F.jsx)(`label`, { children: e }),
      n,
      t && (0, F.jsx)(`span`, { className: `field-error`, children: t }),
    ],
  });
}
function er({ onSave: e, selectedTransaction: t, onCancelEdit: n }) {
  let [r, i] = (0, d.useState)(Zn),
    [a, o] = (0, d.useState)({}),
    [s, c] = (0, d.useState)(``);
  (0, d.useEffect)(() => {
    t
    ...
    children: [
      (0, F.jsx)(`header`, {
        ...
        children: (0, F.jsxs)(`div`, {
          children: [
            (0, F.jsx)(`h1`, {
              children: t ? `Editar Transação` : `Cadastrar Transação`,
            }),
            (0, F.jsx)(`p`, {
              children: t
      ...
      (0, F.jsxs)(`div`, {
        ...
        children: [
          s && (0, F.jsx)(`div`, { className: `success-msg`, children: s }),
          (0, F.jsx)(`div`, {
            className: `tipo-toggle`,
            children: [`entrada`, `saida`].map((e) =>
              (0, F.jsx)(
                `button`,
                {
                  className: `tipo-btn ${e}${r.tipo === e ? ` active` : ``}`,
                  onClick: () => l(`tipo`, e),
                  children: e === `entrada` ? `↑ Entrada` : `↓ Saída`,
                },
                e,
              ),
            ),
            ...
            children: [
              (0, F.jsx)($n, {
                ...
                children: (0, F.jsx)(`input`, {
                  ...
                  value: r.descricao,
                  onChange: (e) => l(`descricao`, e.target.value),
                }),
              }),
              (0, F.jsx)($n, {
                label: `Categoria`,
                ...
                children: (0, F.jsxs)(`select`, {
                  value: r.categoria,
                  onChange: (e) => l(`categoria`, e.target.value),
                  children: [
                    (0, F.jsx)(`option`, {
                      value: ``,
                      children: `Selecione...`,
              ...
              (0, F.jsx)($n, {
                ...
                children: (0, F.jsx)(`input`, {
                  ...
                  step: `0.01`,
                  value: r.valor,
                  onChange: (e) => l(`valor`, e.target.value),
                }),
              }),
              (0, F.jsx)($n, {
                label: `Data`,
          ...
          (0, F.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(`button`, {
                className: `btn-submit ${r.tipo}`,
                onClick: u,
                children: t ? `Salvar alterações` : `Cadastrar Transação`,
              }),
            ],
          }),
        ],
...
function tr() {
  ...
  let m = e.reduce(
    (e, t) => (t.tipo === `entrada` ? e + t.valor : e - t.valor),
    0,
  );
  async function h(e) {
    (s(null), l(``));
    try {
      if (u) {
        let n = await Bn(u.id, e);
        (t((e) => e.map((e) => (e.id === n.id ? n : e))),
          l(`Transação atualizada com sucesso!`));
      } else {
        let n = await zn(e);
        (t((e) => [n, ...e]), l(`Transação cadastrada com sucesso!`));
      }
      (f(null), r(`dashboard`));
    } catch {
      s(`Erro ao salvar transação.`);
    }
  }
  async function g(e) {
    (s(null), l(``));
    try {
      (await Vn(e),
        ...
        u?.id === e && f(null),
        l(`Transação excluída com sucesso!`));
    } catch {
      s(`Erro ao excluir transação.`);
    }
  }
  function _(e) {
    (f(e), r(`cadastro`), l(``), s(null));
  }
  let v = {
    dashboard: (0, F.jsx)(qn, { transactions: e }),
    transacoes: (0, F.jsx)(Yn, { transactions: e, onDelete: g, onEdit: _ }),
    cadastro: (0, F.jsx)(er, {
      onSave: h,
      selectedTransaction: u,
      onCancelEdit: () => f(null),
    }),
  };
  return i
    ? (0, F.jsx)(`div`, { className: `app-loading`, children: `Carregando...` })
    : o
      ? (0, F.jsx)(`div`, { className: `app-error`, children: o })
      : (0, F.jsxs)(`div`, {
          className: `app`,
          children: [
            (0, F.jsx)(Kn, { activeTab: n, onTabChange: r, saldo: m }),
            (0, F.jsxs)(`main`, {
              className: `main`,
              children: [
                c &&
                  (0, F.jsx)(`div`, { className: `app-success`, children: c }),
                v[n],
              ],
            }),
          ],
...
(0, f.createRoot)(document.getElementById(`root`)).render(
  (0, F.jsx)(d.StrictMode, { children: (0, F.jsx)(tr, {}) }),
);
